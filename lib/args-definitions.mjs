...
register(
    'button-gpio-channel',
    'Raspberry Pi pin number where you have plugged your microswitch'
);

register(
    'button-gpio-invert',
    'By default low level means “free”. Pass “true” to change it to “occupied”'
);

register(
    'light-gpio-channel',
    'Raspberry Pi pin number where you have plugged your diode status indicator',
    null
);
